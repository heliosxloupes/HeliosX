...
const Noise: React.FC<NoiseProps> = ({
  ...
  useEffect(() => {
    ...
    // Use smaller canvas size for better performance - 4x fewer pixels
    const canvasSize = 512; // Reduced from 1024
    ...
    const resize = () => {
      ...
      // Let CSS handle the scaling with image-rendering: pixelated
    };
